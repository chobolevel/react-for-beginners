...
function List({ title, movieList }) {
  ...
  const getMaxWidth = () => {
    ...
    const width = getComputedStyle($movieListContent.childNodes[0]).width.substring(
      0,
      getComputedStyle($movieListContent.childNodes[0]).width.indexOf('px')
    )
  ...
  return (
    <div className="movie-list">
      ...
      <div className="movie-list-inner">
        ...
        <div className="movie-list-content" style={{ transform: `translateX(-${x}%)` }}>
          {movieList.map((movie) => (
